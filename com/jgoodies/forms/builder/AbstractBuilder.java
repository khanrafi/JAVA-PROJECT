...
public abstract class AbstractBuilder
{
    ...
    protected AbstractBuilder(final FormLayout layout, final Container container) {
        this.layout = (FormLayout)Preconditions.checkNotNull((Object)layout, "The layout must not be null.");
        this.container = (Container)Preconditions.checkNotNull((Object)container, "The layout container must not be null.");
