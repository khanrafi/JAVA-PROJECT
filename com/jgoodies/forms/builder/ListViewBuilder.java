...
public final class ListViewBuilder
{
    ...
    public ListViewBuilder filterViewColSpec(final String colSpec) {
        Preconditions.checkNotNull((Object)colSpec, "The filter view column specification must not be null.");
    ...
    public ListViewBuilder listView(final JComponent listView) {
        Preconditions.checkNotNull((Object)listView, "The list view must not be null.");
    ...
    public ListViewBuilder listViewRowSpec(final String rowSpec) {
        Preconditions.checkNotNull((Object)rowSpec, "The list view row specification must not be null.");
    ...
    private JComponent buildPanel() {
        Preconditions.checkNotNull((Object)this.listView, "The list view must be set before #build is invoked.");
