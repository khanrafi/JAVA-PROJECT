...
public final class FormSpecParser
{
    ...
    private FormSpecParser(final String source, final String description, final LayoutMap layoutMap, final boolean horizontal) {
        Preconditions.checkNotNull((Object)source, "The %S must not be null.", new Object[] { description });
        Preconditions.checkNotNull((Object)layoutMap, "The LayoutMap must not be null.");
