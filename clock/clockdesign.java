...
class clockdesign extends JPanel {
  ...
  public void move() {
    Thread th = new Thread() {
        public void run() {
          try {
            while (true) {
              clockdesign.this.timeZone = TimeZone.getDefault();
              clockdesign.this.cal = Calendar.getInstance(clockdesign.this.timeZone);
              clockdesign.this.repaint();
              sleep(1000L);
            } 
  ...
  public void paint(Graphics g) {
    ...
    g.fillOval(250, 80, 350, 350);
    g.setColor(Color.BLACK);
    g.fillOval(260, 90, 330, 330);
    this.size = 300;
    this.centerX = 425;
    this.centerY = 255;
    ...
    g.drawRect(190, 520, 170, 35);
    g.drawString("DATE: " + this.day + " " + monthname, 205, 540);
    g.setColor(Color.GREEN);
    g.drawRect(530, 520, 110, 30);
    g.drawString("YEAR: " + this.year, 540, 540);
